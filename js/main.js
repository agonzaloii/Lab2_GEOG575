...
(function () {
    ...
    var attrArray = ["2003", "2004", "2005", "2006",
    ...
    function setMap() {
        ...
        function callback(error, csvData, world /*osm*/) {
    ...
    function setEnumerationUnits(worldCountries, map, path, colorScale) {
        ...
        var osmNations = map.selectAll(".osmCountry")
            .data(worldCountries)
            .enter()
            .append("path")
            .attr("class", function (d) {
                return "osmCountry " + d.properties.NAME;
            })
            .attr("d", path)
            ...
            var desc = osmNations.append("desc")
                .text('{"stroke": "#000", "stroke-width": "0.5"}');

            console.log(osmNations);
    ...
    function changeAttribute(attribute, csvData) {
        ...
        var osmCountry = d3.selectAll(".osmCountry")
            .transition()
            .duration(1000)
            .style("fill", function (d) {
    ...
    function updateChart(bars, n, colorScale){
        ...
        var chartTitle = d3.select(".chartTitle")
            .text("OSM Changeset Count in " + expressed + "."); 
    };
        ...
        if ([expressed] > 0){
            ...
            if (props[expressed] > 0) {
                var labelAttribute = "<h2>" + labelParse +
                    "</h2><b>" + "OSM Changesets produced in " + expressed + ": " + props[expressed] + "</b>";
                }
                else{
                    var labelAttribute = "<h2>" + labelParse +
                "</h2><b>" + "Not part of the select countries." + "</b>";
                };
        }else{
            var labelAttribute = "<h2>" + labelParse +
                "</h2><b>" + "Click dropdown menu to begin OSM Changesets through the years." + "</b>";
